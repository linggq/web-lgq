...
//});
 ...
 $(tab).hover(function(){
            ...
            $("#content_r1 ul").eq(index).show().siblings().hide();;
        });
$("#content_r1").children("ul").first().show().siblings().hide();
 ...
 $(tab2).hover(function(){
            $(this).addClass("cnli").siblings().removeClass("cnli")
                var index = $(this).index();
            $("#content_r2 ul").eq(index).show().siblings().hide();;
        });
$("#content_r2").children("ul").first().show().siblings().hide();
