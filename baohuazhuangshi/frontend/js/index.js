...
//    $(".icona").css("background":"url"("icon2.gif");
    $("p.xian").addClass("bai").siblings("p.xian").removeClass("bai");
  $(this).addClass("hue_lan").siblings().removeClass("hue_lan");
//    $(".hue_lan").add($("xian")).addClass("bai");
})
